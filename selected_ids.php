    ...
    <div class="container"><a class="navbar-brand" href="#page-top">Bossa Kitto Kebele</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false"
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#" id="current"><i class="fa fa-vcard"></i> Selected IDs</a></li>
...
<aside>
	<ul>
		<li id="front_pg" onclick="frontPage();">Front Page</li>
		<li id="back_pg" onclick="backPage();">Back Page</li>
	</ul>
</aside>
...
for($i=1; $i<=8; $i++){
	...
	echo '<div class="sel_id">
		...
		<h1>Notice</h1>
			<ol>
				<li>If this identification card is found lost on the ground, please take it to the resident\'s address or to the respective kebele.</li>
				<li>The resident must have this identification card with him/her at all times.</li>
				<li>If the resident leaves the kebele, he/she must return this identification card back to the kebele.</li>
				<li>This identification card only serves for two years starting from the date it was given.</li>
			</ol>
			<p>Card holder\'s signature ______________</p>
		</div>
		<table class="sel_id_tbl">
			<tr style="border-bottom: 1px solid #333; text-align:center;">
				<th colspan="3">Bossa Kitto Kebele\'s Resident Identification Card
			...
			<tr>
				<td style="width: 40%;"><label>Date of Birth: </label><span>'.$row["res_dob"].'</span></td>
