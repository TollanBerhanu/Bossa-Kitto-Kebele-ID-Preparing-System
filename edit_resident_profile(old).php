...
<!--*************************************************************-->
    ...
    <div class="form-group">
    	<textarea name="res_hou_desc" id="house_Desc" class="form-control" placeholder="Description ..." style="background-color: #F7F7F7; width: 65%; height: 100px; margin-left: 30px; transition: width 0.4s;" onfocus="this.style.width='80%';" onblur="this.style.width='65%';">Hello</textarea>
    </div>
