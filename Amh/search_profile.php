    ...
    <div class="container"><a class="navbar-brand" href="#page-top" >ቦሳ ኪቶ ቀበሌ</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false"
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#" id="current"><i class="fa fa-search"></i> የነዋሪዎችን ገጽታ ፈልግ</a></li>
...
<div class="search_title">የነዋሪዎችን ገጽታ መፈለጊያ ቅጽ
</div>
  <div class="container">
  ...
  <form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>" enctype="multipart/form-data">
  	...
  	<div class="form-group">
  		<span class="search_la" style="display: block;">ሙሉ ስም:</span>
  		...
  		<input type="text" name="ser_res_fname" class="form-control search_ip" placeholder="የራስ"  autocomplete="off" style="width: 29%; float: left; margin-right: 10px;" onfocus="this.style.width='35%';" onblur="this.style.width='29%';" value="<?php if(isset($_POST['ser_res_fname']))echo $_POST['ser_res_fname'];?>">
  		<input type="text" name="ser_res_mname" class="form-control search_ip" placeholder="የአባት"  autocomplete="off" style="width: 29%; float: left; margin-right: 10px;" onfocus="this.style.width='35%';" onblur="this.style.width='29%';" value="<?php if(isset($_POST['ser_res_mname']))echo $_POST['ser_res_mname'];?>">
  		<input type="text" name="ser_res_lname" class="form-control search_ip" placeholder="የአያት"  autocomplete="off" style="width: 29%; float: left;" onfocus="this.style.width='35%';" onblur="this.style.width='29%';" value="<?php if(isset($_POST['ser_res_lname']))echo $_POST['ser_res_lname'];?>">
  	</div>
  	<div class="form-group">
  		<span class="search_la" style="display: inline-block; float: left;">ፆታ:</span>
	  	<div class="search_rb">
	  		<div class="custom-control custom-radio">
			  <input type="radio" name="ser_res_gender" value="Male" class="custom-control-input" id="RadioMale">
			  <label class="custom-control-label" for="RadioMale">ወንድ</label>
			</div> 
			<div class="custom-control custom-radio">
			  <input type="radio" name="ser_res_gender" value="Female" class="custom-control-input" id="RadioFemale">
			  <label class="custom-control-label" for="RadioFemale">ሴት</label>
			</div> 
			<input type="radio" name="ser_res_gender" value="none" style="display:none;" checked>
		</div>
	</div>
	<div class="form-group">
		<span class="search_la" style="display: inline-block; padding-right: 10px; float: left;">የትዉልድ ቀን:</span>
		<input type="number" name="ser_res_dob_day" class="form-control search_dob" placeholder="ቀን" autocomplete="off" style="width: 13%;" value="<?php if(isset($_POST['ser_res_dob_day']))echo $_POST['ser_res_dob_day'];?>">
	    ...
	    <input type="number" name="ser_res_dob_year" class="form-control search_dob" placeholder="ዓመት" autocomplete="off" style="width: 16%;" value="<?php if(isset($_POST['ser_res_dob_year']))echo $_POST['ser_res_dob_year'];?>">
  		<!--<input type="date" name="">-->
  	</div>
    <div class="form-group">
    	<span class="search_la" style="float: left; margin-right: 10px;">ስልክ ቁጥር:</span>
    	<select name="ser_res_tel_type" id="ser_tel_sel" class="form-control search_phone" style="font-size: 14px; height: 25px; width: 15%; float: left; padding: 2px; margin-right: 5px;" onblur="if(document.getElementById('phone_input').value!='' && this.value=='')document.getElementById('opt').selected='true'">
    		<option id="opt_null" value=""></option>
  			<option id="opt" value="Mobile">ሞባይል</option>
  			<option value="Home">የቤት ስልክ</option>
  			<option value="Work">የመስሪያ ቤት ስልክ</option>
  			<option value="Alternate">ተጨማሪ ስልክ</option>
  		</select>
  		<input type="tel" name="ser_res_tel_num" class="form-control search_ip" id="phone_input" onclick="(this.value=='')?this.value='+251-':true;" onkeypress="phone_change();" placeholder="ስልክ ቁጥር" maxlength="16" autocomplete="off" style="width: 35%;" onfocus="this.style.width='45%'; if(document.getElementById('ser_tel_sel').value=='')document.getElementById('opt').selected='true';" onblur="this.style.width='35%'; if(this.value=='+251-')this.value=''; if(this.value=='')document.getElementById('opt_null').selected='true'; ser_Phone_Requirement();">
    </div>
    <div class="form-group">
    	<span class="search_la" style="float: left; margin-right: 10px;">የቤት ቁጥር:</span>
    	<input type="text" name="ser_res_hou_num" class="form-control search_ip" placeholder="የቤት ቁጥር" autocomplete="off" style="float: left; width: 28%;" onfocus="this.style.width='35%';" onblur="this.style.width='28%';" value="<?php if(isset($_POST['ser_res_hou_num']))echo $_POST['ser_res_hou_num'];?>">
    </div>

    <div class="col-lg-12">
    <button class="btn btn-primary btn-lg search_submit" type="submit" name="ser_submit" value="submit"><span>ፈልግ <i class="fa fa-search"></i> </span></button>
	</div>
	<div class="col-lg-12">
    <button class="btn btn-primary btn-lg search_reset" type="reset" onclick="reload();"><span>ሁሉንም መልስ</span></button>
	</div>
    </form>
	</div>
</div>
...
<div class="search_result">
	<div class="search_title">የፍለጋ ዉጤት
	</div>
	<div class="search_result_count" style="text-align: center;"><span id="result_count">0</span> የነዋሪ ገጽታ<span id="result_plural"></span> ተገኝቷል</div>
	...
	echo '<div class="container search_profile">
		<table id="search_result_table">
			<tr>
				...
				<td colspan="2" style="border-bottom: 1px solid #333;"><label>ስም: </label><span>'.$row["res_fname"].' '.$row["res_mname"].' '.$row["res_lname"].'</span></td>
				<td rowspan="3" style="text-align: center; padding: 15px;">
					<div class="search_table_icons">
			...
			<tr style="border-bottom: 1px solid #333;">
				...
				<td><label>ዕድሜ: </label><span>'.$res_age.'</span></td>
			</tr>
			<tr>
				<td colspan="2"><label>ስልክ ቁጥር: </label><span>'.$row["res_tel1_num"].'</span></td>
			</tr>
		</table>
	</div>';
	$result_count++;}
...
<div id="Modal_ID_add" class="modal_sel_id_add">
  ...
  <div class="modal-content_add">
    ...
    <div class="modal_add">
    	<h3 id="profile_added">ይህን ገጽታ መርጠዋል!</h3>
    	<a href="#" id="add_ok">እሺ</a>
    </div>
  </div>
</div>
...
<div id="Modal_ID" class="modal_sel_id">
  ...
  <div class="modal-content">
    ...
    <div class="modal_table">
    	...
    	echo '<table>
    		<tr>
    			<td><label style="margin-left: 0px;">የቤት ቁጥር: </label><span>'.$row["res_hou_num"].'</span></td>
    			<td><label>ሙሉ ስም: </label><span>'.$row["res_fname"].' '.$row["res_mname"].' '.$row["res_lname"].'</span></td>
    			<td><label style="margin-left:50px;">የነዋሪ መለያ: </label><span>'.$row["res_id"].'</span></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td><label style="margin-left:50px;">ፆታ: </label><span>'.$row["res_gender"].'</span></td>
    		</tr>
    		<tr>
    			<td><label>የትዉልድ ቀን: </label><span>'.$row["res_dob"].'</span></td>
    			<td><label style="margin-left:50px;">ዜግነት: </label><span>'.$row["res_nationality"].'</span></td>
    		</tr>
    		<tr>
    			<td><label>ስልክ ቁጥር: </label><span>'.$row["res_tel1_num"].'</span></td>
    			<td><label style="margin-left:50px;">ስራ: </label><span>'.$row["res_work"].'</span></td>
    		</tr>
    		<tr>
    			<td colspan="3"></td>
    		</tr>
    		<tr>
    			<td colspan="3" class="modal_content_different"><label style="margin-left:0px; font-size: 16px; font-style: italic;">የአደገጋ ግዜ ተጠሪ</label><br/>
    			<label style="margin-left:20px;">ስም: </label><span>'.$row["res_emcon_fname"].' '.$row["res_emcon_lname"].'</span><label style="margin-left:50px;">ስልክ ቁጥር: </label><span>'.$row["res_emcon_tel_num"].'</span></td>
    		</tr>
    		<tr>
...
<div id="Modal_ID_delete" class="modal_sel_id_delete">
  ...
  <div class="modal-content_delete">
    ...
    <div class="modal_question_delete">
    	<h3>የዚህን ነዋሪ የተመዘገበ ገጽታ ማጥፋት ትፈልጋለህ?</h3>
...
function openModalAdd(){
	...
	if(select_id < 8){
		...
		document.getElementById('profile_added').innerHTML="ከፍተኛ መታወቂያዎች ተመርጠዋል!";
...
<script>
	...
	document.getElementById('result_plural').innerHTML = '<?php if($result_count != 1)echo "ዎች"; ?>';
</script>
